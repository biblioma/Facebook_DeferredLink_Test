...
namespace Facebook.Unity.Example
{
    ...
    internal class AppInvites : MenuBase
    {
        protected override void GetGui()
        {
			...
			string url = "http://sumikko.playfun.me/api/share/"+random.ToString()+"/?lang=en";
...
//            }
			UnityEngine.Debug.Log("Target Url is "+url);
            if (this.Button("Android Invite With Custom Image"))
            {
                this.Status = "Logged FB.AppEvent";
                FB.Mobile.AppInvite(new Uri(url), new Uri("http://i.imgur.com/zkYlB.jpg"), this.HandleResult);
            }
